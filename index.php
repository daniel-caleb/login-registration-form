...
<head>
    ...
    <title>Emobilis Institute</title>
...
<form action="" method="post">
    ...
    ?>
    <div class="container" style="background-color:#f1f1f1;display: compact">
        <a href="signup.php"><button type="button" class="Regbtn" style="text-align: right">Create an account</button></a>
